...
describe('agentConfirm', () => {
  ...
  it('should reject a proposal when approved is false', async () => {
    ...
    expect(result.agent_event.output?.['rejected_at']).toBeDefined();
  ...
  it('should approve and execute task creation', async () => {
    ...
    expect(result.agent_event.output?.['approved_at']).toBeDefined();
    expect(result.agent_event.output?.['task_id']).toBeDefined();
    expect(typeof result.agent_event.output?.['task_id']).toBe('number');
    expect(result.execution_result).toMatchObject({
      success: true,
      message: 'Task created successfully'
    });
    expect(result.execution_result?.['created_task_id']).toBeDefined();
    expect(typeof result.execution_result?.['created_task_id']).toBe('number');
  ...
  it('should handle task creation failure gracefully', async () => {
    ...
    expect(result.agent_event.output?.['approved_at']).toBeDefined();
    expect(result.agent_event.output?.['execution_error']).toBeDefined();
    expect(typeof result.agent_event.output?.['execution_error']).toBe('string');
    expect(result.execution_result).toMatchObject({
      success: false
    });
    expect(result.execution_result?.['error']).toBeDefined();
    expect(typeof result.execution_result?.['error']).toBe('string');
  });
});