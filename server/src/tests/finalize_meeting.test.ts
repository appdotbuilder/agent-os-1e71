...
describe('finalizeMeeting', () => {
    ...
    it('should finalize meeting with comprehensive transcript', async () => {
        ...
        expect((result.entities['decisions'] as string[]).length).toBeGreaterThan(0);
        expect((result.entities['decisions'] as string[]).some((d: string) => d.includes('decided'))).toBe(true);
